    ...
    render(){
        return (
            ...
            <div className = "chart_content d-flex">
                ...
                <div className = "alert_container col-sm-6 d-flex"  key = {index}{...target}>
                    <div>
                    ...
                    <div className = "alert">
                            <h1>Alert</h1><br />
                            <h3>You have following enquiries</h3>
                            <h3>{target.pending} unattended new enquiries</h3>
                            <h3>since {target.hours} hours and {target.minutes} minutes</h3>
                    </div>
                </div>
               
                ))}
                <div className = "add_patient_button">
                <button className = "join_button" type = "submit" style  = {{marginLeft: "2em"}}>ADD PATIENT</button>
                </div>
            </div>
