              ...
              {enqurie_data.map((target, index) => (
                <div key={index}>
                  <div className="PatientDetails">
                    ...
                    <p>
                      <b>Email : </b> <span>{target.patient_email}</span>
                    </p>
                    <p>
                      <b>Age : </b> <span>{target.patient_age}</span>
                    </p>
                    <p>
                      <b>Gender : </b> <span>{target.patient_gender}</span>
                    </p>
                    <p>
                      <b>Nationality : </b>{" "}
                      <span>{target.patient_nationality}</span>
                    </p>
                    <p>
                      <b>Language : </b>{" "}
                      <span>{target.languages_spoken.join(", ")}</span>
                    </p>
                  </div>
                </div>
              ))}
              ...
              <div className="row">
                {enqurie_data.map((target, index) => (
                  <div key={index} className="col-md-6">
                    ...
                    <p>
                      <b>Medical History : </b>
                      {target.medical_history}&nbsp;&nbsp;{target.med2}
                      &nbsp;&nbsp;{target.med3}
                    </p>
                    <p>
                      <b>Status : </b>
                      {target.status}{" "}
                      {target.status === "Lost Patients" ? (
                        <>
                          <br />
                          <b>Reason :</b>
                ...
                <div className="offset-lg-5 col-md-2 my-2">
                  <div
                    style={{ width: "100%", letterSpecing: 1 }}
          ...
          <div className="container my-5">
            ...
            <div className="py-5">
              {enqurie_data[0].status === "Awaiting From Hospital" ? (
                ...
                enqurie_data[0].status === "Won Patients" ? null : (
                <div className="col-md-12 ">
                  <button
