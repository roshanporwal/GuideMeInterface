         ...
         <div className = "hospital-info col-md-8">
              ...
              { 
                res.services.map((target,index) => (
                  <div className = "hospital_services_container" key = {index}{...target}>
              ...
              <div className = "col-md-4 hospital_photos_container">
                  <h5>Gallery</h5>
                 <div className = "d-flex">
              ...
              <div className = "col-md-6 hospital_photos_container ">
                  <h5>Insurance</h5>
                 <div className = "d-flex">
                 { 
