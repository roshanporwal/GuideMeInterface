        ...
        return (
            ...
            <div className = "patient_table_container">
                ...
                res.patient_table.map((target,index) => (
                        <tr key = {index} {...target} style = {{height: "5rem"}} >
                            <td style = {{paddingLeft: "2rem"}}><Link to = "/ADMIN_PATIENT_DASHBOARD"><button style = {{textDecoration: "none", border: "rgb(204, 197, 197)", background: "rgb(204, 197, 197)"}} onClick={this.showdata(target)}>{target.name}</button></Link></td>
